...
-- | This class is used to print ARM instructions
-- Every instruction that should be printed should be instances of that class
class PrintARM a where
  printARM :: a -> String

-- Instructions is a sequence of string (more efficient than lists)
...
-- | ARM condition for setting flags
data Set = T | F
  deriving (Eq)
...
-- | Second operand of an LDR isntruction
